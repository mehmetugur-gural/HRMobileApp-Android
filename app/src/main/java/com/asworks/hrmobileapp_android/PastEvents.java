...
public class PastEvents extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.activity_past_events, container, false);

        IApiService eventService = IApiService.retrofit.create(IApiService.class);
        Call<ResponseBase<List<Event>>> eventRequest = eventService.pastEventList();
        ...
        eventRequest.enqueue(new Callback<ResponseBase<List<Event>>>() {
            ...
            public void onResponse(Call<ResponseBase<List<Event>>> call, Response<ResponseBase<List<Event>>> response) {
                ...
                if (eventListResponse.data != null)
                {
                    ...
                    recyclerView.addItemDecoration(new PastEvents.GridSpacingItemDecoration(2, dpToPx(10), true));
